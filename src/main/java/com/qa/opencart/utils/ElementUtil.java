...
public class ElementUtil {
	...
	@Step("Enter value in test field using locator : {0} and waiting for element with : {2} secs")
	...
	@Step("Enter value in test field using locator : {0}")
	...
	@Step("giving the state of locator: {0} is displayed or not..")
	...
	/**
	 * This method is usedto enter the value in the text field with a pause
	 * @param locator
	 * @param value
	 * @param pauseTime
	 */
	...
	/**
	 * This method is usedto enter the value in the text field with a pause of 500 ms(by default)
	 * @param locator
	 * @param value
	 */
	...
	@Step("waiting for thetitle and capturing it ...")
